...
import thropyCard from "./3dAssets/TrophyCard.glb";
import envMap from "./3dAssets/kloofendal_48d_partly_cloudy_puresky_4k.hdr";
...
export default function TrophyCard() {
  ...
  function Model() {
    ...
    const { nodes, materials } = useGLTF(thropyCard);
