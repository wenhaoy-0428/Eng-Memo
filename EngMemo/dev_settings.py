"""
Django settings for EngMemo project.
...
SECRET_KEY = 'django-insecure-_lh1z!7b!7xqi8$u27o^ilwewt%=*4$j@p8&kqgueg*h3o)0ep'
...
TEMPLATES = [
    {
        ...
        'DIRS': [ BASE_DIR / 'EngMemo/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'EngMemo.wsgi.application'
